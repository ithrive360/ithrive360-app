...
export default function CardiovascularInsightsPage() {
  ...
  return (
    <div style={{ fontFamily: "'Segoe UI', Tahoma, sans-serif", backgroundColor: 'white' }}>
      {/* Fixed top bar */}
      <div
        style={{
          position: 'fixed',
      ...
      >
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="#3ab3a1" viewBox="0 0 24 24">
            <path d="M15 18l-6-6 6-6" stroke="#3ab3a1" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        </button>
      ...
      <div style={{ padding: '32px 24px', maxWidth: '1100px', margin: '0 auto' }}>
        {/* Insights content continues here */}
